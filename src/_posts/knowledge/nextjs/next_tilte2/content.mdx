...
date: 2025-02-29
description: Next.js, tailwind 환경에 다크모드를 적용해보자.
keywords: [keyword1,keyword2,keyword3]
thumbnail: /posts/knowledge/test.png
---

![](/posts/knowledge/test.png)
...
![3 theme options (dark/light/system) - tailwind css 공식 홈페이지](/posts/knowledge/test.png)

![3 theme options (dark/light/system) - shadcn/ui 공식 홈페이지](/posts/knowledge/test.png)
