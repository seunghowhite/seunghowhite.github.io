...
// post 상세 페이지 내용 조회
export const getPostDetail = async (subject: string, category: string, post: string) => {
  const filePath = `${POSTS_PATH}/${subject}/${category}/${post}/content.mdx`;
